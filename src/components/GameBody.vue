  ...
  <div class="game-body">
    <div class="graph-container">
      ...
      <div class="graph-wrapper">
        <div class="graph"
             v-bind:style="`left: ${setLeft}px; transform: translate(${-12.5 * timeIndex}px, ${(graphData[timeIndex] - 300) * 2}px)`">
          <trend
...
export default {
  ...
  methods: {
    moveGraph () {
      ...
      //     this.timeIndex++
      //     this.x -= 12.5
      //     this.y = (this.graphData[this.timeIndex] - 300) * 2
