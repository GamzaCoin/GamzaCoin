  ...
  <div class="game-body">
    <div class="graph-container">
      <div v-bind:class="`background stage${level}`"
           v-bind:style="{ width: `calc(100% + ${distanceUnit * (graphLength - 1) / 2 + 100}px)`, transform: `translate(${-1 * distanceUnit * timeIndex / 2}px, ${graph[timeIndex] - graph[0]}px)`, transitionDuration: `${timeUnit / 1000 - 50}s`}"></div>
      <div class="graph-wrapper">
        <div class="graph"
             :style="{
                ...
                transitionDuration: `${timeUnit / 1000 - 50}s`
        }">
          <trend
            :data="graph"
            :gradient="['black']"
...
<style>
  ...
  .background {
    ...
    -webkit-transition: transform 0.5s cubic-bezier(0.3, 0.7, 0.6, 1);
    -moz-transition: transform 0.5s cubic-bezier(0.3, 0.7, 0.6, 1);
    -ms-transition: transform 0.5s cubic-bezier(0.3, 0.7, 0.6, 1);
    -o-transition: transform 0.5s cubic-bezier(0.3, 0.7, 0.6, 1);
    transition: transform 0.5s cubic-bezier(0.3, 0.7, 0.6, 1);
  }
